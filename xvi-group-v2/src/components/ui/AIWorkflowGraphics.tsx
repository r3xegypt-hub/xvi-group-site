...
export function AIWorkflowGraphics() {
  return (
    <div className={styles.wrapper} aria-hidden="true">
      <svg className={styles.svg} viewBox="0 0 800 320" fill="none" preserveAspectRatio="xMidYMid slice">
        <defs>
        ...
        <g transform="translate(120, 160)">
          ...
          <text y="-6" textAnchor="middle" fill="#2A2E33" fontSize="11" fontWeight="600">DATA</text>
          <text y="10" textAnchor="middle" fill="#A98533" fontSize="9" fontWeight="500">INGESTION</text>
          <circle r="48" fill="none" stroke="#C8A65A" strokeWidth="1" strokeDasharray="3 9" />
        </g>
        ...
        <g transform="translate(400, 160)">
          ...
          <text y="-8" textAnchor="middle" fill="#2A2E33" fontSize="12" fontWeight="700">AI NEURAL</text>
          <text y="10" textAnchor="middle" fill="#C8A65A" fontSize="10" fontWeight="600">ENGINE</text>
          <circle r="62" fill="none" stroke="#D4B76E" strokeWidth="1.5" strokeDasharray="4 8" />
        </g>
        ...
        <g transform="translate(680, 160)">
          <circle r="44" fill="rgba(255, 255, 255, 0.9)" stroke="rgba(200, 166, 90, 0.4)" strokeWidth="1.5" filter="url(#wfGlow)" />
          <circle r="36" fill="rgba(42, 46, 51, 0.04)" />
          <text y="-6" textAnchor="middle" fill="#2A2E33" fontSize="11" fontWeight="600">REAL-TIME</text>
          <text y="10" textAnchor="middle" fill="#A98533" fontSize="9" fontWeight="500">DECISION</text>
          <circle r="48" fill="none" stroke="#C8A65A" strokeWidth="1" strokeDasharray="3 9" />
        </g>
      </svg>
    </div>
