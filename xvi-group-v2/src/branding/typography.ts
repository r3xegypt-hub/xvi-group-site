...
export const FONT_FAMILIES = {
  ...
  ar: {
    heading: '"Alexandria", "Noto Naskh Arabic", "Noto Sans Arabic", sans-serif',
    body: '"Alexandria", "Noto Naskh Arabic", "Noto Sans Arabic", sans-serif',
    monospace: '"JetBrains Mono", "Fira Code", "Courier New", monospace',
  },
};
...
export const AR_TYPE_SCALE = {
  ...
  display: {
    ...
    letterSpacing: '0',
    fontWeight: 700 as const,
    fontFamily: '"Alexandria", "Noto Naskh Arabic", "Noto Sans Arabic", sans-serif',
  },
  h1: {
